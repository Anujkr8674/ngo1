                        ...
                        <div
                          ...
                          className={`p-4 rounded-xl border cursor-pointer flex items-center justify-between transition-premium text-sm ${
                            formData.interests.includes(interest)
                              ...
                              : "border-foreground/10 bg-white/30 hover:bg-foreground/5 text-foreground/80"
                          }`}
                        >
                          <span>{interest}</span>
                          {formData.interests.includes(interest) && (
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    {role === "volunteer" ? (
                      ...
                      <div className="flex flex-col gap-6">
                        {/* Member Fees detail */}
                        <div className="p-6 rounded-2xl bg-accent/20 border border-accent/20 flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-foreground/5">
                  {step > 1 ? (
                    <button
                      type="button"
                      onClick={prevStep}
                      className="px-6 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider text-foreground hover:bg-foreground/5 transition-premium border border-foreground/5 cursor-pointer"
                    >
                      Back
                    </button>
                  ) : (
                  ...
                  {step < 3 ? (
                    ...
                    <button
                      type="submit"
                      className="px-8 py-3 rounded-full text-xs font-semibold uppercase tracking-wider text-white bg-foreground hover:bg-[#2c2c2c] transition-premium shadow-soft cursor-pointer"
                    >
                      Submit Application
                    </button>
                  )}
