...
import { User, Mail, Phone, Calendar, MapPin, Check, BookOpen, ShieldCheck, Heart, Sparkles, AlertCircle, Upload, X, FileText } from "lucide-react";
    ...
    <div className="flex flex-col w-full min-h-screen font-sans text-foreground">
          ...
          <div className="w-full text-center flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6 w-full max-w-md mx-auto">
              <button
                ...
                className={`w-full sm:w-auto px-8 py-4 rounded-full text-base font-semibold transition-premium shadow-soft cursor-pointer bg-[#CFE8FF] text-[#444444] hover:bg-[#b8daff] ${role === "volunteer" ? "ring-4 ring-white/50 scale-105" : "opacity-70 hover:opacity-100"
                  }`}
              >
                As Volunteer
              </button>
              <button
                ...
                className={`w-full sm:w-auto px-8 py-4 rounded-full text-base font-semibold transition-premium shadow-soft cursor-pointer bg-[#dccff8] text-[#444444] hover:bg-[#cbb6f5] ${role === "member" ? "ring-4 ring-white/50 scale-105" : "opacity-70 hover:opacity-100"
                  }`}
              >
                As Member
              </button>
      ...
      <section className="py-8 px-6 md:px-12 pb-16">
        <div className="bg-[#FFE6D4] rounded-[3rem] py-8 px-4 md:py-16 md:px-8 border border-foreground/5 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* Form wizard or Single Page Registration */}
                    ...
                    {step === 2 && (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {interestsList.slice(0, 9).map((interest) => (
                            <div
                              key={interest}
                              onClick={() => handleInterestChange(interest)}
                              className={`p-4 rounded-xl border cursor-pointer flex items-center justify-between transition-premium text-sm ${formData.interests.includes(interest)
