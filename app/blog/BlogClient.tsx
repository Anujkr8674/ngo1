...
export default function BlogClient({ initialBlogs, initialCategories }: BlogClientProps) {
  ...
  const displayedBlogs = filteredBlogs.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE)
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {/* Magazine Grid */}
      <section id="blog-grid" className="py-8 px-6 md:px-12 pb-16">
