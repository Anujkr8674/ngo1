...
export default async function BlogPostPage({ params }: PageProps) {
 ...
 <Link 
 href="/blog" 
 className="inline-flex items-center gap-2 text-xs font-semibold text-white/60 hover:text-white mb-2 group px-4 py-1.5 rounded-full shadow-soft"
 >
 ...
 {/* Featured Image */}
 {blog.images && blog.images.length > 0 && (
 <div className="aspect-[16/9] w-full rounded-[2.5rem] relative overflow-hidden shadow-premium border border-white mb-12">
