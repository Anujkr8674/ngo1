...
import { ShieldCheck, Sparkles, X, Eye } from "lucide-react";
                ...
                <div className="bg-[#FFE6D4] rounded-[3rem] py-8 px-4 md:py-16 md:px-8 border border-foreground/5 max-w-7xl mx-auto flex flex-col gap-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {certificates.map((cert) => (
                            <div key={cert.title} className="p-6 rounded-2xl bg-[#F6F7FA] border border-foreground/5 shadow-soft flex flex-col justify-between min-h-[200px] hover:-translate-y-2 hover:border-primary hover:shadow-premium hover:bg-[#CFE8FF] transition-all duration-300">
