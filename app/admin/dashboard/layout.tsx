...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    <div className="flex flex-col h-full w-full">
      ...
      <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard'
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/stats'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
          <ListTree className={`h-5 w-5 transition-colors ${pathname === '/admin/dashboard/stats' ? 'text-[#444444]' : 'text-slate-400 group-hover:text-[#444444]'}`} />
          Stats Counters
        </Link>
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/csr-partnerships'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
          <Briefcase className={`h-5 w-5 transition-colors ${pathname === '/admin/dashboard/csr-partnerships' ? 'text-[#444444]' : 'text-slate-400 group-hover:text-[#444444]'}`} />
          CSR Partnerships
        </Link>
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/categories'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/gallery'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/agm'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/archived-material'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/donors-csr-sponsors-members'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/students'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/initiatives'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/testimonials'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/contact'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/donations'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
        ...
        <div>
          <button
            ...
            className={`flex items-center justify-between px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group cursor-pointer ${pathname.startsWith('/admin/dashboard/volunteer') || pathname.startsWith('/admin/dashboard/member')
              ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
              : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
              }`}
          >
          ...
          {isBePartUsOpen && (
            <div className="mt-1 ml-4 pl-3 border-l-2 border-purple-200 space-y-1">
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/volunteer'
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/member'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
        ...
        <div>
          <button
            ...
            className={`flex items-center justify-between px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group cursor-pointer ${pathname.startsWith('/admin/dashboard/get-help')
              ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
              : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
              }`}
          >
          ...
          {isGetHelpOpen && (
            <div className="mt-1 ml-4 pl-3 border-l-2 border-purple-200 space-y-1">
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/get-help/each-other'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/get-help/education'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/get-help/elderly'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/get-help/medical'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
          ...
          {isWebPostsOpen && (
            <div className="mt-1 ml-4 pl-3 border-l-2 border-blue-200 space-y-1">
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/posts/categories'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 w-full rounded-lg transition-all text-xs font-semibold ${pathname === '/admin/dashboard/posts'
                  ? 'bg-blue-50 text-blue-700 font-bold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'
                  }`}
              >
        ...
        <Link
          ...
          className={`flex items-center gap-3 px-4 py-3 w-full rounded-xl transition-all font-medium text-sm group ${pathname === '/admin/dashboard/about'
            ? 'bg-gradient-to-r from-[#DCCFF8] to-[#CFE8FF] text-[#444444] font-bold shadow-sm'
            : 'text-slate-500 hover:text-[#444444] hover:bg-slate-50'
            }`}
        >
  ...
  return (
    <div className="h-screen bg-slate-50 flex text-[#444444] font-admin relative">
      ...
      <aside
        className={`fixed inset-y-0 left-0 w-72 bg-white border-r border-slate-200 flex flex-col md:hidden shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        {sidebarContent}
      </aside>
