            ...
            {submitted ? (
              ...
              <form onSubmit={handleFormSubmit} className="flex flex-col gap-10">
                <div className="border-b border-foreground/5 pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <a
                    href="/get-help-form/Help-Each-Other-Form.pdf"
                    target="_blank"
                    ...
                    <div className="flex flex-col gap-3 text-sm">
                      {[
                        ...
                        <div
                          ...
                          className={`p-3.5 rounded-xl border cursor-pointer flex items-center justify-between transition-all duration-300 text-xs ${eachOtherData.helpTypes.includes(type)
